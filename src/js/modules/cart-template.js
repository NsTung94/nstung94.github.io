...
export const cartTemplate = (product) => {
  ...
  cartDecrease.classList.add('btn',"cartpage-box", "cartpage__product-quantity--decrease", 'js-cart-decrease');
  const cartQuantityNumber = document.createElement("div");
  cartQuantityNumber.classList.add('btn',"cartpage-box","cartpage__product-quantity--number");
  cartQuantityNumber.innerHTML = `${product.cartQuantity}`;
  const cartIncrease = document.createElement("div");
  cartIncrease.classList.add('btn',"cartpage-box","cartpage__product-quantity--increase", 'js-cart-increase');
